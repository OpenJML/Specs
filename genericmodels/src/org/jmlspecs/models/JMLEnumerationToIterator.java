 ...
 */
public class JMLEnumerationToIterator<E> implements JMLIterator<E> {

    protected final /*@ spec_public non_null @*/ JMLEnumeration<E> theEnumeration;
    ...
    /*@ public normal_behavior
      ...
      @*/
    //@ pure
    public JMLEnumerationToIterator(/*@ non_null @*/ JMLEnumeration<E> e) {
        //@ set owner = null;
        Object o = e.clone();
        //@ assume o != null && o instanceof JMLEnumeration;
        theEnumeration = (JMLEnumeration<E>) o;
    ...
    /*@ also
      ...
      @*/
    public E next() throws JMLNoSuchElementException {
        E result = theEnumeration.nextElement();
    ...
    public /*@ pure @*/ Object clone() {
        ...
        //@ assume o != null && o instanceof JMLEnumeration;
        return new JMLEnumerationToIterator<E>((JMLEnumeration<E>) o);
    } //@ nowarn Post;
    ...
    public /*@ pure @*/ boolean equals(/*@ nullable @*/ Object oth) {
        return oth != null
            && oth instanceof JMLEnumerationToIterator
            && theEnumeration.equals(((JMLEnumerationToIterator<E>) oth)
                                     .theEnumeration);
    }
