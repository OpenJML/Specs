...
/*@ nullable_by_default @*/ 
public /*@ pure @*/ abstract class JMLValueSequenceSpecs<E extends JMLType> implements JMLValueType
{
    ...
    /*@ public normal_behavior
      ...
      @*/
    public abstract int count(E elem);
     ...
     */
    public abstract /*@ nullable @*/ E itemAt(int i)
     ...
     *  @see #last
     */
    public abstract /*@ nullable @*/ E first()
        throws JMLSequenceException
               /*@ public model_program {
     ...
     *  @see #first
     */
    public abstract /*@ nullable @*/ E last()
        throws JMLSequenceException
               /*@ public model_program {
     ...
     *  @see #insertFront
     */
    public abstract /*@ non_null @*/ JMLValueSequence<E>
        insertAfterIndex(int afterThisOne, E item)
        throws JMLSequenceException
               /*@ public model_program {
                 @    assume item != null;
     ...
     */
    public abstract /*@ non_null @*/ JMLValueSequence<E>
        insertBeforeIndex(int beforeThisOne, E item)
        throws JMLSequenceException
               /*@ public model_program {
                 @    assume item != null;
     ...
     *  @see #insertFront
     */
    public abstract /*@ non_null @*/ JMLValueSequence<E> insertBack(E item)
        /*@ public model_program {
    ...
    public abstract /*@ non_null @*/
        JMLValueSequence<E> insertFront(E item)
        /*@ public model_program {
          @    assume item != null && int_length() < Integer.MAX_VALUE;
          @    JMLType copy = (JMLType)item.clone();
          @
